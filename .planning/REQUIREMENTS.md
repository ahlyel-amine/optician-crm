...
- [x] **CLIENT-06**: A new ordonnance for a client is stored as a new version; earlier ordonnances remain readable and are never overwritten
...
- [x] **CLIENT-09**: A user can attach a photo of the paper ordonnance to the structured record, as evidence for an AMO claim
