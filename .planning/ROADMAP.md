...
- [ ] 03-06-PLAN.md — Registre de projection, quatre consommateurs, test de conformité paramétré (PERM-05, PERM-06)
- [ ] 03-07-PLAN.md — Portée magasin : `get_queryset`, champ lié restreint, oracle de tri fermé, gardes d'énumération (PERM-04, PERM-05)
...
- [ ] 03-11-PLAN.md — Formatage client et registre de colonnes filtré par présence, moitié cliente de PERM-06 (APP-03, PERM-06)
...
| 3. Comptes, Permissions & App Shell | 3/14 | In Progress|  |
